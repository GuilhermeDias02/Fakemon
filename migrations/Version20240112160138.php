 ...
 */
final class Version20240112160138 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE pokemon (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) DEFAULT NULL, image VARCHAR(255) DEFAULT NULL, id_pokedex VARCHAR(255) DEFAULT NULL, id_nat INT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE pokemon_region (pokemon_id INT NOT NULL, region_id INT NOT NULL, INDEX IDX_638B8D222FE71C3E (pokemon_id), INDEX IDX_638B8D2298260155 (region_id), PRIMARY KEY(pokemon_id, region_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
